...
# Burn Painter
BP2 is a burn treatment simulator in Unreal that enabled medical teachers to implement virtual scenarios for treating burn patients. Created a burn editor that allowed them to specify the types, locations, and extents of burns themselves instead of relying on developers to do so.
